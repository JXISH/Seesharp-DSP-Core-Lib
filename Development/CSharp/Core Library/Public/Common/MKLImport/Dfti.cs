...
namespace SeeSharpTools.JXI.MKL
{
    internal static class Dfti
    {
        ...
        //[DllImport(Constants.MKLCoreFilePath, CallingConvention = CallingConvention.StdCall, EntryPoint = "DftiCreateDescriptor_d_1d")]
    ...
    /// </summary>
    internal enum DftiConfigValue:int
    {
        /// <summary>
        /// DFTI_COMMIT_STATUS
        /// </summary>
    ...
    internal enum DftiConfigPARAM:int
    {
        /// <summary>
